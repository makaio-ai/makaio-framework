...
export class ShellManager {
  ...
  /**
   * Dispose this manager and release all process-level ownership.
   *
   * Running shells are terminated, retained shell entries are cleared, the
   * cleanup timer is stopped, and this manager is removed from the global
