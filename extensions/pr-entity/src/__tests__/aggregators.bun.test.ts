...
import type { VCSCheckRun, VCSCommitStatus, VCSReview, ReviewFinding, LabelSemantic } from '@makaio/contracts';
import {
...
describe('classifyLabel', () => {
  it.each<[string, string]>([
    ...
    expect(classifyLabel(label)).toBe(expected as LabelSemantic);
  });
