...
import type { MessageRouting, MessageRoutingStatus } from '@makaio/contracts';
 ...
 */
export function registerDrizzleMessageRoutingStorage(bus: IMakaioBus, db: MakaioDatabase): () => void {
