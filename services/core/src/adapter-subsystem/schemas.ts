...
import { ProviderContextSchema } from '@makaio/contracts/adapter';
import { AdapterFileSchema } from '@makaio/contracts/config';
import { ModelFilterModeSchema, ModelVisibilitySchema, ProviderDefinitionSchema } from '@makaio/contracts/provider';
import {
...
export const ProviderConfigFileRecordSchema = z
  .object({
    ...
    name: z.string(),
    endpointOverrides: z.record(z.string(), z.string()).optional(),
...
export const AdapterSubsystemSchemas = {
  ...
  buildProviderContext: {
    ...
    response: z
      .object({
        context: ProviderContextSchema.nullable(),
      })
      .strict(),
  },
  ...
  setProviderConfigCredentialRefs: {
    request: z
      .object({
        id: z.string(),
        credentialRefs: CanonicalProviderConfigCredentialRefsSchema,
      })
      .strict(),
    response: z
      .object({
