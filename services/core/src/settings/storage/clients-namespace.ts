...
import { ClientAuthMethodsSchema, ClientDefaultAuthSchema } from '@makaio/contracts/auth';
...
export const ClientRecordSchema = z
  .object({
    ...
    /** Authentication methods declared by the client package. */
    authMethods: ClientAuthMethodsSchema,
    /** Native authentication method used by the client's managed default config. */
