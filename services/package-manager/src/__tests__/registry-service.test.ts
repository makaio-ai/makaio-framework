 ...
 * @param mockFn - The vitest mock to augment
 * @returns The mock cast to `typeof fetch` with `preconnect` attached
 */
function asFetch(mockFn: ReturnType<typeof vi.fn>): typeof fetch {
  return Object.assign(mockFn, { preconnect: vi.fn() }) as typeof fetch;
}
