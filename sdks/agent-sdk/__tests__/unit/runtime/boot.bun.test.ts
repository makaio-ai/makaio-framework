...
const shutdownMock = mock<() => Promise<void>>(() => Promise.resolve());
const bootMock = mock(() => Promise.resolve({ shutdown: shutdownMock } as never));

mock.module('@makaio/runtime-node', () => ({
...
mock.module('@makaio/runtime-node/extension-discovery', () => ({
...
mock.module('@makaio/contracts', () => ({
  parseExtensionDescriptor: (descriptor: unknown) => descriptor,
}));

mock.module('@makaio/kernel/providers', () => ({
