...
import { executeAgentStep, executeShellStep, failResult } from './workflow-step-executors.js';
...
export class InProcessStepRunner implements IStepRunner {
  ...
  public async run(config: StepRunConfig, _signal: AbortSignal): Promise<StepRunResult> {
