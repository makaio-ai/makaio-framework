...
function makeDeps(): StrategyDependencies {
  ...
  return {
    fetchText: mock(notCalled('fetchText')),
    fetchJson: mock(notCalled('fetchJson')),
    downloadFile: mock(notCalled('downloadFile')),
    exec: mock(notCalled('exec')),
    extractArchive: mock(notCalled('extractArchive')),
    deleteFile: mock(notCalled('deleteFile')),
    computeChecksum: mock(notCalled('computeChecksum')),
    removeDirectory: mock(notCalled('removeDirectory')),
  };
}
