 ...
 * - **Nested framework checkout**: repo root contains `framework/package.json`; the
 *   workspace root is the nearest ancestor (up to 4 levels) that contains
 *   `framework/package.json`.
 * - **Standalone framework repo**: repo root contains `package.json` directly;
 ...
 * 2. **Standalone fallback** — if no nested-layout marker is found, accept the
 ...
 * @throws If neither supported repo layout is detected at any candidate depth.
 */
