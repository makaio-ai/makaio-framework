...
export { installExtensionPackages, listInstalledExtensionPackages } from './bus/package-manager-ops.js';
export type { InstalledExtensionPackage } from './bus/package-manager-ops.js';
