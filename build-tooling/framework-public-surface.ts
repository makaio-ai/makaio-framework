...
export const FRAMEWORK_DIST_SUBPATHS = [
  ...
  { subpath: 'clients', sourceDist: 'packages/clients-core/dist', packageName: '@makaio/clients-core' },
  {
    subpath: 'services/log-import',
    sourceDist: 'packages/services/log-import/dist',
  ...
  { subpath: 'tools', sourceDist: 'tools/core/dist', packageName: '@makaio/tools-core' },
  { subpath: 'tools/testing', sourceDist: 'tools/core/dist/testing', packageName: '@makaio/tools-core' },
  { subpath: 'tools/filesystem', sourceDist: 'tools/filesystem/dist', packageName: '@makaio/tools-filesystem' },
  { subpath: 'tools/shell', sourceDist: 'tools/shell/dist', packageName: '@makaio/tools-shell' },
  { subpath: 'tools/subagent', sourceDist: 'tools/subagent/dist', packageName: '@makaio/tools-subagent' },
...
export const FRAMEWORK_PUBLIC_PACKAGE_SUBPATHS = [
  ...
  { packageName: '@makaio/clients-core', frameworkSubpath: 'clients', packageRoot: 'packages/clients-core' },
  {
    packageName: '@makaio/services-log-import',
  ...
  { packageName: '@makaio/tools-core', frameworkSubpath: 'tools', packageRoot: 'tools/core' },
  { packageName: '@makaio/tools-filesystem', frameworkSubpath: 'tools/filesystem', packageRoot: 'tools/filesystem' },
  { packageName: '@makaio/tools-shell', frameworkSubpath: 'tools/shell', packageRoot: 'tools/shell' },
  { packageName: '@makaio/tools-subagent', frameworkSubpath: 'tools/subagent', packageRoot: 'tools/subagent' },
