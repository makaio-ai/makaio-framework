...
- Runtime bare imports in browser entry bundles must be limited to the shared browser
  externals: `react`, `react-dom`, `react/jsx-runtime`, and `@makaio/web-framework`.
