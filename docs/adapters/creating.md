...
the [Adapter hub document](./index.md). For model and provider configuration,
see [Models & Providers](./models-and-providers). For how adapters are
discovered and loaded at boot, see [Discovery](./discovery).
