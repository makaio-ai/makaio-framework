...
| Defined in | [`packages/services/core/src/settings/storage/providers-namespace.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/packages/services/core/src/settings/storage/providers-namespace.ts) |
