...
| Defined in | [`services/core/src/session/adapter-sessions/namespace.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/services/core/src/session/adapter-sessions/namespace.ts) |
