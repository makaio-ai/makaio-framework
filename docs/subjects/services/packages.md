...
| Field | Type | Required |
|-------|------|----------|
| `packages` | `{ name: string; version: string; hasDescriptor: boolean; description?: string \| undefined; descriptorName?: string \| undefined; serverImportPath?: string \| undefined; critical?: boolean \| undefined; }[]` | yes |
