...
| `ingestCompleted` | [`storage:turn.ingestCompleted`](#storage:turn.ingestCompleted) | rpc | [`schemas.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/services/core/src/turn/schemas.ts) |
