...
| Defined in | [`packages/services/core/src/harness/storage/namespace.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/packages/services/core/src/harness/storage/namespace.ts) |
