...
| `warnings.changed` | [`kernel:extension.warnings.changed`](#kernel:extension.warnings.changed) | event | [`extension-warning.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/packages/contracts/src/extension/extension-warning.ts) |
