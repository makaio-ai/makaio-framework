...
| `outcome` | `"reserved" \| "occupied" \| "lead-conflict" \| "agent-disposed" \| "not-found" \| "machine-identity-unavailable"` | yes |
| `reservation` | `{ agentId: string; sessionId: string; machineId: string; adapterId: string; claim: { machineId: string; adapterId: string; providerSessionId: string; claimId: string; adapterName: string; sessionId: string; agentId: string; claimToken: string; fence: number; status: "held" \| "releasing" \| "abandoned"; claimedAt: number; updatedAt: number; } \| null; leadDesignated: boolean; previousLeadAgentId: string \| null; } \| undefined` | no |
