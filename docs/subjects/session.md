...
| `agent.attachResolved` | [`session.agent.attachResolved`](#session.agent.attachResolved) | rpc | [`orchestrator.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/orchestrator.ts) |
...
| `locality.degraded` | [`session.locality.degraded`](#session.locality.degraded) | event | [`events.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/events.ts) |
...
| `ownership.continuation` | [`session.ownership.continuation`](#session.ownership.continuation) | rpc | [`ownership.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/ownership.ts) |
| `ownership.reconcile` | [`session.ownership.reconcile`](#session.ownership.reconcile) | rpc | [`ownership.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/ownership.ts) |
| `ownership.release` | [`session.ownership.release`](#session.ownership.release) | rpc | [`ownership.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/ownership.ts) |
| `ownership.reserveStart` | [`session.ownership.reserveStart`](#session.ownership.reserveStart) | rpc | [`ownership.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/ownership.ts) |
| `ownership.settleMovement` | [`session.ownership.settleMovement`](#session.ownership.settleMovement) | rpc | [`ownership.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/ownership.ts) |
...
| `turn.assistantPersistenceSettled` | [`session.turn.assistantPersistenceSettled`](#session.turn.assistantPersistenceSettled) | event | [`orchestrator.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/core/contracts/src/session/schemas/orchestrator.ts) |
...
### <a id="session.agent.attachResolved"></a>`session.agent.attachResolved` (rpc)
...
Subject: `session.agent.attachResolved`
Type: Request (RPC)
...
|-------|------|----------|
| `eventId` | `string` | yes |
| `payload` | `{ sessionId: string; agentId: string; adapterId: string; adapterName: string; adapterSessionId?: string \| undefined; role?: "lead" \| "member" \| undefined; model?: string \| undefined; cwd?: string \| undefined; } \| { sessionId: string; turnId: string; turnNumber: number; messageId: string; content: string \| { blocks: { type: "text"; content: string; } \| { type: "image"; source: { type: "base64"; data: string; mimeType: string; } \| { type: "url"; url: string; mimeType?: string \| undefined; }; } \| { type: "document"; source: { type: "base64"; data: string; mimeType: string; } \| { type: "url"; url: string; mimeType?: string \| undefined; }; } \| { type: "attachment"; fileName: string; filePath: string; source: { type: "base64"; data: string; mimeType: string; } \| { type: "url"; url: string; mimeType?: string \| undefined; }; attachmentType: "file" \| "directory"; displayName?: string \| undefined; } \| { type: "reasoning"; content: string; metadata?: Record<string, unknown> \| undefined; } \| { type: "tool_call"; toolCallId: string; name: string; args: Record<string, unknown>; } \| { type: "tool_output"; toolCallId: string; output: string; isError?: boolean \| undefined; } \| ({ type: "text"; content: string; } \| { type: "image"; source: { type: "base64"; data: string; mimeType: string; } \| { type: "url"; url: string; mimeType?: string \| undefined; }; } \| { type: "document"; source: { type: "base64"; data: string; mimeType: string; } \| { type: "url"; url: string; mimeType?: string \| undefined; }; } \| { type: "attachment"; fileName: string; filePath: string; source: { type: "base64"; data: string; mimeType: string; } \| { type: "url"; url: string; mimeType?: string \| undefined; }; attachmentType: "file" \| "directory"; displayName?: string \| undefined; } \| { type: "reasoning"; content: string; metadata?: Record<string, unknown> \| undefined; } \| { type: "tool_call"; toolCallId: string; name: string; args: Record<string, unknown>; } \| { type: "tool_output"; toolCallId: string; output: string; isError?: boolean \| undefined; })[]; role?: "user" \| "assistant" \| "system" \| undefined; }; agentIds: string[]; source?: "user" \| "system" \| "extension" \| undefined; origin?: "text" \| "voice" \| "compact" \| undefined; } \| { sessionId: string; turnId: string; turnNumber: number; messageId: string; agentId: string; } \| { sessionId: string; turnId: string; turnNumber: number; messageId: string; agentId: string; outcome: "error" \| "superseded" \| "completed" \| "merged" \| "cancelled" \| "rejected"; supersededBy?: string \| undefined; mergedInto?: string \| undefined; error?: string \| undefined; } \| { sessionId: string; turnId: string; turnNumber: number; messageId: string; agentIds: string[]; initiator?: { source: "user" \| "system" \| "extension"; sourceId?: string \| undefined; } \| undefined; ingestionMarker?: "live" \| "backfill" \| undefined; } \| { sessionId: string; turnId: string; turnNumber: number; success: boolean; error?: string \| undefined; usage?: { total: { inputTokens: number; outputTokens: number; cachedInputTokens?: number \| undefined; cost?: number \| undefined; }; byAgent?: Record<string, { inputTokens: number; outputTokens: number; cachedInputTokens?: number \| undefined; cost?: number \| undefined; }> \| undefined; } \| undefined; initiator?: { source: "user" \| "system" \| "extension"; sourceId?: string \| undefined; } \| undefined; ingestionMarker?: "live" \| "backfill" \| undefined; } \| { messageId: string; turnId: string \| null; role: "user" \| "assistant"; } \| { childSessionId: string; parentSessionId: string; kind: "fork" \| "subagent" \| "compress" \| "branch" \| "rewrite" \| "coordinator" \| "aside"; forkPointMessageId?: string \| undefined; } \| { childSessionId: string; parentSessionId: string; resultJson?: string \| undefined; resultMessageId?: string \| undefined; } \| { summaryJson: string; tokensBefore?: number \| undefined; tokensAfter?: number \| undefined; compressedMessageIds?: string[] \| undefined; } \| { intent: "fork" \| "resume"; verdictKind: "degrade"; reason: "adapter-unsupported" \| "adapter-mismatch" \| "no-adapter-session" \| "missing-machine-id" \| "machine-mismatch" \| "cwd-mismatch" \| "transforms-present" \| "compression-present" \| "connector-swap" \| "mid-history-unsupported" \| "hybrid-imported-orchestrated" \| "native-attempt-failed" \| "agent-already-started" \| "fork-point-unresolvable" \| "adapter-session-moved"; agentId?: string \| undefined; adapterId?: string \| undefined; turnId?: string \| undefined; } \| { intent: "fork" \| "resume"; verdictKind: "foreign"; foreignMachineId: string; agentId?: string \| undefined; adapterId?: string \| undefined; turnId?: string \| undefined; } \| Record<string, unknown>` | yes |
| `sessionId` | `string` | yes |
| `timestamp` | `number` | yes |
| `type` | `"agent.added" \| "user_message.sent" \| "user_message.acknowledged" \| "user_message.completed" \| "turn.started" \| "turn.completed" \| "message" \| "branch.created" \| "branch.merged" \| "squash" \| "locality.degraded" \| string` | yes |
...
| Field | Type | Required |
|-------|------|----------|
| `state` | `{ currentTokens: number; maxTokens: number; percentage: number; level: "ok" \| "warn" \| "critical"; lastUpdatedAt: number; } \| null` | yes |
...
| `status` | `"all" \| "active" \| "closed" \| "archived" \| "discovered" \| undefined` | no |
...
### <a id="session.locality.degraded"></a>`session.locality.degraded` (event)
...
| `eventId` | `string` | yes |
| `foreignMachineId` | `string \| undefined` | no |
| `intent` | `"fork" \| "resume"` | yes |
| `reason` | `"adapter-unsupported" \| "adapter-mismatch" \| "no-adapter-session" \| "missing-machine-id" \| "machine-mismatch" \| "cwd-mismatch" \| "transforms-present" \| "compression-present" \| "connector-swap" \| "mid-history-unsupported" \| "hybrid-imported-orchestrated" \| "native-attempt-failed" \| "agent-already-started" \| "fork-point-unresolvable" \| "adapter-session-moved" \| undefined` | no |
| `sessionId` | `string` | yes |
| `timestamp` | `number` | yes |
| `turnId` | `string \| undefined` | no |
| `verdictKind` | `"degrade" \| "foreign"` | yes |
...
### <a id="session.ownership.continuation"></a>`session.ownership.continuation` (rpc)
...
|-------|------|----------|
| `sessionId` | `string` | yes |
| `startMode` | `"resume" \| "compact"` | yes |

**Response:**

| Field | Type | Required |
|-------|------|----------|
| `outcome` | `"reopened" \| "unchanged" \| "not-found" \| "unresolved"` | yes |
| `sessionId` | `string \| undefined` | no |

### <a id="session.ownership.reconcile"></a>`session.ownership.reconcile` (rpc)
...
| Field | Type | Required |
|-------|------|----------|
| `claims` | `{ claim: { machineId: string; adapterId: string; providerSessionId: string; claimId: string; adapterName: string; sessionId: string; agentId: string; ownerInstanceId: string \| null; claimToken: string; fence: number; status: "held" \| "releasing" \| "abandoned"; claimedAt: number; updatedAt: number; }; verdict: "abandoned" \| "retained" \| "vanished"; reason?: "agent-disposed" \| "agent-gone" \| "adapter-instance-gone" \| "owner-instance-retired" \| undefined; }[] \| undefined` | no |
| `machineId` | `string \| undefined` | no |
| `outcome` | `"reconciled" \| "skipped"` | yes |
| `reason` | `"machine-identity-unavailable" \| undefined` | no |

### <a id="session.ownership.release"></a>`session.ownership.release` (rpc)
...
### <a id="session.ownership.reserveStart"></a>`session.ownership.reserveStart` (rpc)
...
| `expectedLeadAgentId` | `string \| null \| undefined` | no |
| `machineId` | `string \| undefined` | no |
...
| `resumeProviderSessionId` | `string \| null` | yes |
| `role` | `"lead" \| "member"` | yes |
| `sessionId` | `string` | yes |
...
| `outcome` | `"currency-changed" \| "recovery-conflict" \| "reserved" \| "occupied" \| "lead-conflict" \| "agent-disposed" \| "session-not-active" \| "not-found" \| "machine-identity-unavailable"` | yes |
...
| `reservation` | `{ agentId: string; sessionId: string; adapterId: string; ownerInstanceId: string; leadDesignated: boolean; previousLeadAgentId: string \| null; machineId: string; claim: { machineId: string; adapterId: string; providerSessionId: string; claimId: string; adapterName: string; sessionId: string; agentId: string; ownerInstanceId: string \| null; claimToken: string; fence: number; status: "held" \| "releasing" \| "abandoned"; claimedAt: number; updatedAt: number; }; recovery?: { attemptId: string; preimage: { status: "starting" \| "idle" \| "active" \| "dead" \| "disposed"; adapterId: string; binding?: { adapterId: string; ownerMachineId: string; ownerInstanceId: string; } \| undefined; recoveryAttemptId?: string \| undefined; }; } \| undefined; } \| { agentId: string; sessionId: string; adapterId: string; ownerInstanceId: string; leadDesignated: boolean; previousLeadAgentId: string \| null; claim: null; recovery?: { attemptId: string; preimage: { status: "starting" \| "idle" \| "active" \| "dead" \| "disposed"; adapterId: string; binding?: { adapterId: string; ownerMachineId: string; ownerInstanceId: string; } \| undefined; recoveryAttemptId?: string \| undefined; }; } \| undefined; machineId?: string \| undefined; } \| undefined` | no |
| `revision` | `number \| undefined` | no |
| `status` | `"starting" \| "idle" \| "active" \| "dead" \| "disposed" \| "closed" \| "archived" \| "discovered" \| undefined` | no |

### <a id="session.ownership.settleMovement"></a>`session.ownership.settleMovement` (rpc)
...
| `holder` | `{ machineId: string; adapterId: string; providerSessionId: string; claimId: string; adapterName: string; sessionId: string; agentId: string; ownerInstanceId: string \| null; claimToken: string; fence: number; status: "held" \| "releasing" \| "abandoned"; claimedAt: number; updatedAt: number; } \| undefined` | no |
| `outcome` | `"settled" \| "idempotent" \| "already-claimed" \| "superseded" \| "currency-changed" \| "not-owner" \| "agent-disposed" \| "not-found" \| "machine-identity-unavailable"` | yes |
...
| Field | Type | Required |
|-------|------|----------|
| `agent` | `{ [x: string]: unknown; kind: "adapter"; providerConfigId?: string \| undefined; model?: string \| undefined; reasoningEffort?: "none" \| "low" \| "medium" \| "high" \| "extra-high" \| undefined; cwd?: string \| undefined; systemPrompt?: string \| { mode: "append"; content: string; } \| undefined; allowedTools?: string[] \| undefined; disallowedTools?: string[] \| undefined; env?: Record<string, string> \| undefined; mcpSessionContext?: { sessionId: string; servers: { name: string; transport: { type: "stdio"; command: string; args?: string[] \| undefined; env?: Record<string, string> \| undefined; alwaysLoad?: boolean \| undefined; } \| { url: string; type: "sse"; headers?: Record<string, string> \| undefined; tools?: { name: string; permission_policy: "always_allow" \| "always_ask" \| "always_deny"; }[] \| undefined; alwaysLoad?: boolean \| undefined; } \| { url: string; type: "http"; headers?: Record<string, string> \| undefined; tools?: { name: string; permission_policy: "always_allow" \| "always_ask" \| "always_deny"; }[] \| undefined; alwaysLoad?: boolean \| undefined; }; exposureMode: "direct" \| "discovery"; }[]; directTools: { fullName: string; originalName: string; serverName: string; inputSchema: Record<string, unknown>; exposureMode: "direct" \| "discovery" \| "hidden"; enabled: boolean; exposed: boolean; description?: string \| undefined; enabledBy?: "discovery" \| "toolset" \| undefined; enabledAt?: number \| undefined; }[]; discoverableTools: { fullName: string; originalName: string; serverName: string; inputSchema: Record<string, unknown>; exposureMode: "direct" \| "discovery" \| "hidden"; enabled: boolean; exposed: boolean; description?: string \| undefined; enabledBy?: "discovery" \| "toolset" \| undefined; enabledAt?: number \| undefined; }[]; } \| undefined; allowedDirectories?: string[] \| undefined; adapterConfig?: Record<string, unknown> \| undefined; adapterName?: string \| undefined; adapterId?: string \| undefined; machineId?: string \| undefined; } \| { [x: string]: unknown; kind: "canonical-model"; model: string; providerConfigId?: string \| undefined; reasoningEffort?: "none" \| "low" \| "medium" \| "high" \| "extra-high" \| undefined; cwd?: string \| undefined; systemPrompt?: string \| { mode: "append"; content: string; } \| undefined; allowedTools?: string[] \| undefined; disallowedTools?: string[] \| undefined; env?: Record<string, string> \| undefined; mcpSessionContext?: { sessionId: string; servers: { name: string; transport: { type: "stdio"; command: string; args?: string[] \| undefined; env?: Record<string, string> \| undefined; alwaysLoad?: boolean \| undefined; } \| { url: string; type: "sse"; headers?: Record<string, string> \| undefined; tools?: { name: string; permission_policy: "always_allow" \| "always_ask" \| "always_deny"; }[] \| undefined; alwaysLoad?: boolean \| undefined; } \| { url: string; type: "http"; headers?: Record<string, string> \| undefined; tools?: { name: string; permission_policy: "always_allow" \| "always_ask" \| "always_deny"; }[] \| undefined; alwaysLoad?: boolean \| undefined; }; exposureMode: "direct" \| "discovery"; }[]; directTools: { fullName: string; originalName: string; serverName: string; inputSchema: Record<string, unknown>; exposureMode: "direct" \| "discovery" \| "hidden"; enabled: boolean; exposed: boolean; description?: string \| undefined; enabledBy?: "discovery" \| "toolset" \| undefined; enabledAt?: number \| undefined; }[]; discoverableTools: { fullName: string; originalName: string; serverName: string; inputSchema: Record<string, unknown>; exposureMode: "direct" \| "discovery" \| "hidden"; enabled: boolean; exposed: boolean; description?: string \| undefined; enabledBy?: "discovery" \| "toolset" \| undefined; enabledAt?: number \| undefined; }[]; } \| undefined; allowedDirectories?: string[] \| undefined; adapterConfig?: Record<string, unknown> \| undefined; } \| { [x: string]: unknown; kind: string; providerConfigId?: string \| undefined; model?: string \| undefined; reasoningEffort?: "none" \| "low" \| "medium" \| "high" \| "extra-high" \| undefined; cwd?: string \| undefined; systemPrompt?: string \| { mode: "append"; content: string; } \| undefined; allowedTools?: string[] \| undefined; disallowedTools?: string[] \| undefined; env?: Record<string, string> \| undefined; mcpSessionContext?: { sessionId: string; servers: { name: string; transport: { type: "stdio"; command: string; args?: string[] \| undefined; env?: Record<string, string> \| undefined; alwaysLoad?: boolean \| undefined; } \| { url: string; type: "sse"; headers?: Record<string, string> \| undefined; tools?: { name: string; permission_policy: "always_allow" \| "always_ask" \| "always_deny"; }[] \| undefined; alwaysLoad?: boolean \| undefined; } \| { url: string; type: "http"; headers?: Record<string, string> \| undefined; tools?: { name: string; permission_policy: "always_allow" \| "always_ask" \| "always_deny"; }[] \| undefined; alwaysLoad?: boolean \| undefined; }; exposureMode: "direct" \| "discovery"; }[]; directTools: { fullName: string; originalName: string; serverName: string; inputSchema: Record<string, unknown>; exposureMode: "direct" \| "discovery" \| "hidden"; enabled: boolean; exposed: boolean; description?: string \| undefined; enabledBy?: "discovery" \| "toolset" \| undefined; enabledAt?: number \| undefined; }[]; discoverableTools: { fullName: string; originalName: string; serverName: string; inputSchema: Record<string, unknown>; exposureMode: "direct" \| "discovery" \| "hidden"; enabled: boolean; exposed: boolean; description?: string \| undefined; enabledBy?: "discovery" \| "toolset" \| undefined; enabledAt?: number \| undefined; }[]; } \| undefined; allowedDirectories?: string[] \| undefined; adapterConfig?: Record<string, unknown> \| undefined; } \| undefined` | no |
...
### <a id="session.turn.assistantPersistenceSettled"></a>`session.turn.assistantPersistenceSettled` (event)
...
| Field | Type | Required |
|-------|------|----------|
| `completion` | `{ sessionId: string; turnId: string; turnNumber: number; success: boolean; error?: string \| undefined; usage?: { total: { inputTokens: number; outputTokens: number; cachedInputTokens?: number \| undefined; cost?: number \| undefined; }; byAgent?: Record<string, { inputTokens: number; outputTokens: number; cachedInputTokens?: number \| undefined; cost?: number \| undefined; }> \| undefined; } \| undefined; initiator?: { source: "user" \| "system" \| "extension"; sourceId?: string \| undefined; } \| undefined; ingestionMarker?: "live" \| "backfill" \| undefined; }` | yes |
