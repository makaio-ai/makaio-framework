...
| `refresh` | [`vcs:pr.refresh`](#vcs:pr.refresh) | rpc | [`schemas.ts`](https://github.com/makaio-ai/makaio-framework/blob/develop/packages/contracts/src/capabilities/vcs-pr/schemas.ts) |
