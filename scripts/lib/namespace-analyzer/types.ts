...
export interface SubjectEntry {
  ...
  /** Fields of the event payload schema. Present only for event subjects when extraction succeeds. */
  payload?: SubjectField[];

  /** Fields of the RPC request schema. Present only for RPC subjects when extraction succeeds. */
  request?: SubjectField[];

  /** Fields of the RPC response schema. Present only for RPC subjects when extraction succeeds. */
