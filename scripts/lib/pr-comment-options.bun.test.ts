...
describe('parseCliOptions', () => {
  ...
  it('rejects dash-prefixed positional-looking tokens passed as state-file values', () => {
    expect(() =>
      parseCliOptions(['--new', '--state-file', '-1', 'https://github.com/makaio-ai/makaio-framework/pull/1']),
    ).toThrow('--state-file requires a file path.');
  });
