...
/**
 * MakaioNodeExtension<IMakaioBus> descriptor for the Cursor provider.
 *
...
/**
 * Package descriptor for the Cursor provider.
 */
export const cursorProviderPackage: MakaioNodeExtension<IMakaioBus> = {
  name: 'provider-cursor',
  displayName: 'Cursor Provider',
  version: '0.1.0',
