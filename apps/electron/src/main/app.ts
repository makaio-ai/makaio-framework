...
/* eslint max-lines-per-function: ["error", { "max": 600 }] */

/**
 * Electron app composition root — wires infrastructure, bus handlers, tray,
 * window management, and shutdown lifecycle inside the single-instance lock.
 */
