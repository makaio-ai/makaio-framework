    ...
    try {
      ...
      if (nativeTool) {
        ...
        try {
          ...
          // @google/gemini-cli-core 0.39.1 ToolInvocation.execute accepts
          // ExecuteOptions, not a bare signal; this preserves native tool
          // cancellation while leaving room for SDK live-output callbacks.
