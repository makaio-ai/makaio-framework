# @makaio/ai-adapters-codex-app-server
...
} from '@makaio/ai-adapters-codex-app-server';
...
Runtime registration is contributed by `@makaio/ai-adapters-codex-app-server/server`.
