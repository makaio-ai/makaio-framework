...
function makeCallbacks(): HookEventCallbacks {
  return {
    onSessionStart: mock<HookEventCallbacks['onSessionStart']>(),
    onUserPromptSubmit: mock<HookEventCallbacks['onUserPromptSubmit']>(),
    onPreToolUse: mock<HookEventCallbacks['onPreToolUse']>(),
    onPostToolUse: mock<HookEventCallbacks['onPostToolUse']>(),
    onStop: mock<HookEventCallbacks['onStop']>(),
  };
}
