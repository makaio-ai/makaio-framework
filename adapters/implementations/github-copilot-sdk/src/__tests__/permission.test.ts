...
function makeDelegate(requestToolApproval: PermissionHandlerDelegate['requestToolApproval']): {
  ...
  handleError: ReturnType<typeof vi.fn<PermissionHandlerDelegate['handleError']>>;
  handleToolApprovalDenied: ReturnType<typeof vi.fn<PermissionHandlerDelegate['handleToolApprovalDenied']>>;
} {
  return {
    requestToolApproval,
    handleError: vi.fn<PermissionHandlerDelegate['handleError']>(),
    handleToolApprovalDenied: vi.fn<PermissionHandlerDelegate['handleToolApprovalDenied']>(),
  };
}
